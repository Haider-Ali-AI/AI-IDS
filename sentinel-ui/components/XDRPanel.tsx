  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div>
        ...
        {chains.length === 0 ? (
          <div className="glass-card" style={{ padding: "24px", textAlign: "center", color: "var(--text-muted)", fontFamily: "var(--font-mono)", fontSize: 12 }}>
            No active chains. System monitoring…
          </div>
        ) : (
